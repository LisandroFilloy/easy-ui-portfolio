      ...
      <div className="z-10">
        <div className="space-y-8 md:text-center">
          ...
          <p className="regular-paragraph mx-auto max-w-[835px]">
            Hi 👋, I&apos;m{' '}
            <span className="text-code text-yellow-600">Lisandro Filloy</span>, a
            passionate software developer with a knack for creating visually stunning,
            scalable, high-performance applications and reusable systems. With a strong
            foundation in <span className="text-green-700">frontend</span> and
            <span className="text-blue-600"> backend technologies</span>, I
            specialize in crafting solutions that are impactful for{' '}
            <span className="text-orange-500">users</span>.
          </p>
        </div>

        <div className="mt-16 flex flex-wrap gap-8 md:mt-24 mb-16">
          {skills.map((skill) => {
